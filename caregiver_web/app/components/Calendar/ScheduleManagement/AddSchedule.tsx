            ...
            {selectedCaregiverForSchedule && (
              <Card style={{ padding: '12px', backgroundColor: 'var(--blue-2)' }}>
                <Text size="2" weight="medium">
                  선택된 보호사: {apiCaregivers.find(c => c.caregiverId === selectedCaregiverForSchedule)?.name}
                </Text>
              </Card>
            )}
          ...
          <Flex direction="column" gap="4">
            ...
            <Card style={{ padding: '16px', backgroundColor: 'var(--green-2)' }}>
              <Flex direction="column" gap="3">
                ...
                {selectedCaregiverForSchedule && (
                  <Text size="2">
                    {apiCaregivers.find(c => c.caregiverId === selectedCaregiverForSchedule)?.name} ({apiCaregivers.find(c => c.caregiverId === selectedCaregiverForSchedule)?.phone})
                  </Text>
                )}
              </Flex>
            </Card>
